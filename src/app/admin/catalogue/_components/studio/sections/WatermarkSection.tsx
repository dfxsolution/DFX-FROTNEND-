...
import { Stamp, UploadCloud } from 'lucide-react';
...
export const WatermarkSection: React.FC = () => {
  const { watermark, setWatermark, product, reloadProduct, mediaLibrary, mediaLibraryLoading, addToMediaLibrary } =
    useStudio();
