...
import { Check, FileText, UploadCloud, Scan, SlidersHorizontal, Download, Lock } from 'lucide-react';
import { cn } from '@/lib/utils';
import { STUDIO_STEPS, useStudio } from '../StudioContext';

const STEP_ICONS = [FileText, UploadCloud, Scan, SlidersHorizontal, Download];
